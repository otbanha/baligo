...
**今日任務：搜尋近期真實新聞並整理 5 則**

⚠️ 嚴格規定：
1. 請用 Google Search 搜尋「Bali news」、「Bali travel」、「巴厘岛 新闻」等關鍵字，找出最近 7 天內的真實新聞
2. 每一則都必須是真正搜尋到的新聞，並在段落結尾標注來源，格式：「（來源：媒體名稱，日期）」
3. **禁止憑記憶、訓練資料或推測來生成新聞內容**，若找不到足夠真實新聞，寧可減少則數也不能捏造
4. 可參考的新聞來源：Bali Post、The Bali Sun、Coconuts Bali、Jakarta Post、Kompas、CNN Indonesia、各大華語旅遊媒體

涵蓋範圍（有真實新聞才寫）：
- 峇里島本地最新動態、旅遊政策、安全警示
- 台灣、香港、新加坡、馬來西亞與峇里島之間的互動新聞（直航、入境新規、旅遊合作等）
- 各地旅客前往峇里島的實用差異提醒
語氣友善，全文使用繁體中文。
...
若 7 天內沒有節慶，第 5 則照常寫一般旅遊話題（同樣須有真實來源）。
...
[話題一內容，段落結尾加上：（來源：媒體名稱，YYYY/MM/DD）]

## 2. [話題二標題] [相關 emoji]

[話題二內容，段落結尾加上：（來源：媒體名稱，YYYY/MM/DD）]

## 3. [話題三標題] [相關 emoji]

[話題三內容，段落結尾加上：（來源：媒體名稱，YYYY/MM/DD）]

## 4. [話題四標題] [相關 emoji]

[話題四內容，段落結尾加上：（來源：媒體名稱，YYYY/MM/DD）]

## 5. [話題五標題] [相關 emoji]

[話題五內容，段落結尾加上：（來源：媒體名稱，YYYY/MM/DD）]
