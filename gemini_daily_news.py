...
確認好內容後，請用以下格式輸出（不要加前言後記，不要用 markdown 代碼塊包住）：

ARTICLE_SUBTITLE: （3 個話題關鍵字，頓號分隔）
ARTICLE_SLUG: bali-news-{tomorrow.strftime('%Y-%m-%d')}
ARTICLE_DESCRIPTION: （50-80 字 SEO 描述）
TOPICS_JSON: ["話題1", "話題2", "話題3", "話題4", "話題5"]
...
[內文 150-200 字，結尾標注來源：（來源：媒體名稱，日期）]
