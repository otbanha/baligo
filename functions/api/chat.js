...
【重要知識】入境二維碼（DPHI/電子入境卡）共用：峇里島入境填寫嘅電子入境卡（QR Code），係一人一個，唔可以兩個人共用同一個二維碼，每位旅客都要各自填寫同出示自己嗰個。
...
【重要知識】入境二維碼共用：峇里島入境電子卡（QR Code）**每人一個**，不可兩人共用同一個二維碼。每位旅客都必須各自填寫並出示自己的二維碼。
...
- 當被問到「入境二維碼（電子入境卡）可不可以兩個人共用」或「一個二維碼給兩個人用」時，必須回答：**不可以共用**，每位旅客都必須各自填寫並出示自己的入境電子卡二維碼，一人一個。
