...
const PINNED_ARTICLES = [
  {
    ...
    articles: [
      { title: '【峇里島包車司機推薦名人榜】巴里島司機網友評鑑大全：看網友真實點評找到適合你的好司機', url: '/blog/bali-private-car-drivers-guide/' },
      { title: '峇里島包車自由行全攻略 - 常見問題、費用、預訂方式、優勢分析', url: '/blog/bali-private-car-hire-guide/' },
      { title: '峇里島什麼時候包車？什麼場合叫車？包車 vs. 叫車：如何選擇最適合你的旅行方式？', url: '/blog/bali-transportation-guide-car-rental/' },
    ],
  },
  {
    ...
    articles: [
      { title: '2026年峇里島自由行｜行前終極指南：出發前必看 7 大重點！簽證、換匯、住宿、電壓/轉接器...一次搞定', url: '/blog/bali-travel-guide-2026/' },
    ],
  },
  {
    ...
    articles: [
      { title: '【峇里島旅遊指南】新手必看 8 大注意事項：飲水安全、電壓插頭、文化禁忌與防坑建議', url: '/blog/bali-travel-tips/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島換匯攻略，哪裡換最划算？', url: '/blog/bali-currency-exchange-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島旅遊費用? 峇里島旅遊要準備多少現金？', url: '/blog/bali-travel-cash-budget-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島 SIM 卡推薦，最穩上網方案', url: '/blog/bali-sim-card-esim-roaming-guide/' },
    ],
  },
  {
  ...
  },
  {
    ...
    articles: [
      { title: '峇里島簽證申請攻略', url: '/blog/bali-all-indonesia-arrival-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島衝浪完全攻略：初學者必看的場地、課程與注意事項', url: '/blog/bali-surf-beaches-guide/' },
      { title: '峇里島衝浪推薦：最適合初學者的海灘與衝浪學校', url: '/blog/2026-bali-water-activities/' },
    ],
  },
  {
    ...
    articles: [
      { title: '【2026 峇里島美食攻略】10 大必吃經典與街頭小吃：烤乳豬、沙嗲到髒鴨飯全紀錄', url: '/blog/2026-bali-food-guide/' },
      { title: '峇里島必嚐10大印尼美食指南：從髒鴨餐到烤乳豬，舌尖上的南洋風情', url: '/blog/top-10-bali-indonesian-food/' },
      { title: '烏布美食推薦｜峇里島最強食記：從髒鴨飯、豬肋排到稻田網美咖啡廳', url: '/blog/ubud-food-guide/' },
      { title: '庫塔美食推薦｜峇里島最強美食攻略', url: '/blog/kuta-best-food-guide/' },
      { title: '水明漾美食攻略｜浪漫、精緻與地道峇里島的完美結合', url: '/blog/seminyak-restaurants-food-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島肚子不適/Bali Belly完整攻略：預防、症狀與治療方法', url: '/blog/bali-belly-medicine-guide/' },
    ],
  },
  {
    keywords: ['ATV', 'atv', 'quad bike', 'quad biking', 'off-road', '越野車', '越野'],
    articles: [
      { title: '峇里島 ATV 越野車體驗推薦', url: '/blog/bali-atv-adventure-guide/' },
    ],
  },
  {
  ...
  },
  {
    ...
    articles: [
      { title: '峇里島水上活動推薦：浮潛、潛水、香蕉船', url: '/blog/2026-bali-water-activities/' },
    ],
  },
  {
    ...
    articles: [
      { title: '佩尼達島包車司機怎麼選?｜旅人實用推薦包車與安排方式', url: '/blog/nusa-penida-private-driver-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '【峇里島 - Nusa Penida 佩尼達島全攻略】地圖、搭船、住宿、交通、包車、活動、攝影、景點', url: '/blog/nusa-penida-guide/' },
      { title: '【Nusa Penida攻略五】佩尼達島的住宿推薦: 14間從奢華到平價的 Nusa Penida 好評住宿', url: '/blog/nusa-penida-hotels-guide/' },
    ],
  },
  {
    keywords: ['ijen', 'Ijen', 'IJEN', '伊真', '伊真火山', '藍火', 'blue fire', 'Blue Fire', 'blue flame'],
    articles: [
      { title: '🌋【伊真火山+峇里島】夢幻藍火+賽武瀑布+布羅莫日出｜輕奢五日遊全包', url: '/blog/ijen-bromo-bali-luxury-tour/' },
    ],
  },
  {
    keywords: ['canggu', 'Canggu', 'CANGGU', '長谷', '倉古', 'Berawa', 'berawa', 'Batu Bolong', 'batu bolong'],
    articles: [
      { title: '峇里島Canggu完美探險地圖：100個長谷/倉古必遊景點｜2025指南', url: '/blog/canggu-guide/' },
      { title: '長谷區16間私人泳池別墅推薦 Canggu Villa 你不能錯過的峇里島別墅', url: '/blog/canggu-villas-guide/' },
      { title: 'Holiday Inn Resort Bali Canggu 峇里島長谷假日酒店：兩大入住兩小免費 豪華與舒適都有', url: '/blog/holiday-inn-bali-canggu/' },
    ],
  },
  {
    ...
    articles: [
      { title: '【水明漾】不超過100美元的平價峇里島villa推薦', url: '/blog/seminyak-budget-villas-guide/' },
      { title: '峇里島住宿推薦：10間水明漾精華區平價住宿好評推薦！', url: '/blog/seminyak-budget-hotels-guide/' },
    ],
  },
  {
    keywords: ['seminyak', 'Seminyak', 'SEMINYAK', '水明漾', 'Legian', 'legian', '雷吉安'],
    articles: [
      { title: '【水明漾攻略】峇里島水明漾景點Seminyak必去地點地圖：100個吃喝玩樂全面介紹｜2026最佳旅遊指南', url: '/blog/seminyak-guide/' },
      { title: '【峇里島住宿推薦】巴里島VILLA泳池別墅私密天堂:水明漾22間令人驚艷的峇里島villa', url: '/blog/seminyak-private-villas-guide/' },
  ...
  },
  {
    ...
    articles: [
      { title: '2026峇里島完整烏布攻略：100種深入認識烏布的方式｜探索烏布的魅力', url: '/blog/ubud-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '2026峇里島完整烏布攻略：100種深入認識烏布的方式｜探索烏布的魅力', url: '/blog/ubud-guide/' },
      { title: '【烏布住宿推薦】烏布泳池別墅私密天堂: 20間令人驚艷的峇里島villa推薦', url: '/blog/ubud-villa-pool-guide/' },
      { title: '【峇里島烏布住宿】烏布特色住宿推薦，體驗峇里島山林美景中的奇幻之旅！', url: '/blog/ubud-villas-pool-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島旅遊必訪景點：海神廟（Tanah Lot）詳細介紹及潮汐、周邊景點指南', url: '/blog/bali-tanah-lot-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '【烏魯瓦圖攻略】Uluwatu烏魯瓦圖景點 50個吃喝玩樂推薦', url: '/blog/uluwatu-guide/' },
      { title: '烏魯瓦圖 Uluwatu住宿推薦：14間無敵海景的私密別墅渡假村', url: '/blog/uluwatu-bali-villas-resorts-guide/' },
      { title: '峇里島烏魯瓦圖廟/情人崖旅遊指南：必看亮點與實用建議', url: '/blog/uluwatu-temple-travel-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '努沙杜瓦、南灣：峇里島豪華度假的首選之地40個住宿、美食、活動攻略地圖 Nusa Dua/Tanjung Benoa', url: '/blog/nusa-dua-guide/' },
    ],
  },
  {
    keywords: ['sanur', 'Sanur', 'SANUR', '沙努爾'],
    articles: [
      { title: '峇里島家庭親子自由行：Sanur沙努爾攻略地圖｜超過50項吃喝玩樂，還有SPA和住宿推薦喔！', url: '/blog/sanur-guide/' },
      { title: '峇里島住宿推薦：Sanur沙努爾22家從奢華到平價的渡假村/villa收集', url: '/blog/sanur-luxury-budget-resorts/' },
      { title: '峇里島家庭親子旅遊首選: 最安全的戲水海灘 - 沙努爾', url: '/blog/sanur-family-beach-guide/' },
    ],
  },
  {
  ...
  },
  {
    ...
    articles: [
      { title: '峇里島居然有五個旅遊旺季！如何避開旺季聰明旅遊？', url: '/blog/bali-peak-season-travel-tips/' },
      { title: '峇里島旺季旅遊攻略：如何避開交通擁堵，輕鬆享受假期', url: '/blog/bali-peak-season-travel-guide/' },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: '峇里島攻略之認識峇里島區域：峇里島住宿推薦指南 - 認識庫塔 水明漾 倉古 烏布', url: '/blog/bali-accommodation-area-guide/' },
      { title: '庫塔美食推薦｜峇里島最強美食攻略', url: '/blog/kuta-best-food-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島金巴蘭海鮮推薦：11家海鮮餐廳不踩雷推薦', url: '/blog/jimbaran-seafood-restaurants-list/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島住宿推薦：無敵海景金巴蘭住宿篇', url: '/blog/jimbaran-beachfront-hotels-guide/' },
      { title: '【峇里島阿雅那】Ayana Bali 住宿懶人包》Ayana Segara, RIMBA, Ayana Resort..', url: '/blog/ayana-resort-bali-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島自由行金巴蘭攻略：推薦30個玩樂景點全攻略｜2026旅遊指南', url: '/blog/jimbaran-guide/' },
      { title: '【武吉半島冒險指南】從金巴蘭日落到烏魯瓦圖懸崖寺廟：峇里島南端的隱藏天堂', url: '/blog/bukit-peninsula-guide/' },
      { title: '峇里島金巴蘭海鮮推薦：10家海鮮餐廳不踩雷推薦', url: '/blog/jimbaran-seafood-restaurants-list/' },
    ],
  },
  {
  ...
  },
  {
    ...
    articles: [
      { title: '【峇里島阿雅那】Ayana Bali 住宿懶人包》Ayana Segara, RIMBA, Ayana Resort..', url: '/blog/ayana-resort-bali-guide/' },
      { title: '【峇里島】阿雅娜度假村體驗之旅：Ayana Villa 奢華別墅與金巴蘭的五星級享受', url: '/blog/ayana-resort-villa-experience/' },
      { title: '峇里島金巴蘭岩石酒吧 Rock Bar 如何預約？完整體驗攻略！', url: '/blog/bali-rock-bar-reservation-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '「如何規劃峇里島自由行？」峇里島旅行規劃攻略：7 個步驟輕鬆搞定巴里島完美旅程！', url: '/blog/2026-bali-trip-planning-guide/' },
      { title: '只想放鬆？這些峇里島Klook一日遊行程讓你0規劃也能玩得盡興', url: '/blog/klook-bali-day-tours-guide/' },
    ],
  },
  {
    keywords: ['啤酒巴士', '啤酒車', 'beer bus', 'Beer Bus', 'BEER BUS', 'beer truck', 'party bus'],
    articles: [
      { title: '峇里島啤酒巴士（啤酒車）完整攻略', url: '/blog/kuta-beer-on-wheels-bali/' },
    ],
  },
  {
    ...
    articles: [
      { title: '峇里島獨旅全攻略', url: '/blog/bali-solo-travel-guide/' },
    ],
  },
  {
  ...
  },
  {
    ...
    articles: [
      { title: '峇里島自由行注意事項：15個前往峇里島北部旅遊的小貼士', url: '/blog/north-bali-travel-guide/' },
      { title: '【2026 峇里島包車推薦】網友評鑑司機名人榜：不踩雷真實點評與預約教學', url: '/blog/bali-private-car-drivers-guide/' },
    ],
  },
  {
    ...
    articles: [
      { title: '可以攜帶檳榔入境峇里島/印尼嗎?', url: '/blog/bali-betel-nut-customs/' },
    ],
  },
  {
