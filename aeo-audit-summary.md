...
> 產生時間：2026-07-04　掃描 767 篇　跳過 9 篇
> 詳細逐篇資料見 aeo-audit-report.csv

## 總覽

- **全站平均分數：59.7 / 100**
- 分項平均：A 直接回答 15.2/30　B 結構化資料 15.2/25　C 可擷取性 10.6/20　D 實體一致性 12.2/15　E 新鮮度 6.4/10
- 分數分布：0-40 分 **24 篇**　41-60 分 **340 篇**　61-80 分 **394 篇**　81-100 分 **9 篇**

## 各分類平均分數

| 分類 | 篇數 | 總分 | A/30 | B/25 | C/20 | D/15 | E/10 |
|---|---|---|---|---|---|---|---|
| 旅行技巧 | 185 | 62.7 | 15.2 | 19.9 | 10.3 | 11.1 | 6.1 |
| 美食景點活動 | 162 | 59.5 | 14.9 | 14.6 | 11.2 | 12.6 | 6.2 |
| 住宿推薦 | 93 | 62.7 | 16.5 | 14.2 | 11.3 | 13.4 | 7.2 |
| 新聞存檔 | 87 | 46.8 | 11.1 | 10.9 | 6.7 | 12.7 | 5.4 |
| 遊記分享 | 71 | 57.6 | 14.4 | 12.2 | 11.4 | 12.4 | 7.2 |
| 峇里島分區攻略 | 60 | 64.3 | 17.8 | 15.6 | 11.6 | 12.6 | 6.8 |
| 簽證通關 | 44 | 60.7 | 18 | 14.4 | 11.2 | 10.8 | 6.3 |
| 家庭親子 | 37 | 61.2 | 15.7 | 13.9 | 12.3 | 12.4 | 6.9 |
...
4. **住宿文 Hotel schema 未輸出（hotel-cache.json 有 253 筆資料）** — 12/93 篇（13%）
   ...
   - 層級：layout/一次性
5. **更新日期超過 30 個月或含過時訊號** — 58/767 篇（8%）
   - 修法：逐篇查核後補 updatedDate；優先處理實用類（價格/簽證/交通）
   - 層級：逐篇
6. **長段落敘事牆（>150字段落比例高）** — 53/767 篇（7%）
