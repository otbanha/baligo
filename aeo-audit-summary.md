...
- **全站平均分數：59.1 / 100**
- 分項平均：A 直接回答 15/30　B 結構化資料 15/25　C 可擷取性 10.6/20　D 實體一致性 12.2/15　E 新鮮度 6.4/10
- 分數分布：0-40 分 **29 篇**　41-60 分 **347 篇**　61-80 分 **383 篇**　81-100 分 **7 篇**

## 各分類平均分數

| 分類 | 篇數 | 總分 | A/30 | B/25 | C/20 | D/15 | E/10 |
|---|---|---|---|---|---|---|---|
| 旅行技巧 | 185 | 60.9 | 14.5 | 18.8 | 10.3 | 11.1 | 6.1 |
| 美食景點活動 | 162 | 59.3 | 14.7 | 14.6 | 11.2 | 12.6 | 6.2 |
| 住宿推薦 | 93 | 62.7 | 16.5 | 14.2 | 11.3 | 13.4 | 7.2 |
| 新聞存檔 | 86 | 46.8 | 11.2 | 10.9 | 6.7 | 12.7 | 5.4 |
| 遊記分享 | 71 | 57.5 | 14.3 | 12.2 | 11.4 | 12.4 | 7.2 |
| 峇里島分區攻略 | 60 | 64.1 | 17.5 | 15.6 | 11.6 | 12.6 | 6.8 |
| 簽證通關 | 44 | 60.1 | 17.4 | 14.4 | 11.2 | 10.8 | 6.3 |
| 家庭親子 | 37 | 61.2 | 15.7 | 13.9 | 12.3 | 12.4 | 6.9 |
| 叫車包車 | 19 | 55.8 | 16.1 | 12.5 | 10.1 | 10.5 | 6.5 |
...
1. **缺列點式 TL;DR 摘要（layout callout 只有單句）** — 726/766 篇（95%）
   ...
   - 層級：逐篇（可半自動）
2. **沒有 FAQ schema 也沒有文內常見問題區塊** — 500/766 篇（65%）
   - 修法：兩段修：(1) SEO.astro 把 FAQPage 擴充到更多分類（layout 一次解決）(2) 逐篇補「常見問題」H2 區塊
   - 層級：部分layout/部分逐篇
3. **開頭 150 字沒有直接回答** — 489/766 篇（64%）
