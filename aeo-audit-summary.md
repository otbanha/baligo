...
- **全站平均分數：59.5 / 100**
- 分項平均：A 直接回答 15.1/30　B 結構化資料 15.2/25　C 可擷取性 10.6/20　D 實體一致性 12.2/15　E 新鮮度 6.4/10
- 分數分布：0-40 分 **24 篇**　41-60 分 **342 篇**　61-80 分 **393 篇**　81-100 分 **7 篇**

## 各分類平均分數

| 分類 | 篇數 | 總分 | A/30 | B/25 | C/20 | D/15 | E/10 |
|---|---|---|---|---|---|---|---|
| 旅行技巧 | 185 | 62.5 | 15 | 19.9 | 10.3 | 11.1 | 6.1 |
...
1. **缺列點式 TL;DR 摘要（layout callout 只有單句）** — 726/766 篇（95%）
   ...
   - 層級：逐篇（可半自動）
2. **開頭 150 字沒有直接回答** — 492/766 篇（64%）
   - 修法：逐篇改開頭；description 已有答案的可半自動搬進內文首段
   - 層級：逐篇（可半自動）
3. **沒有 FAQ schema 也沒有文內常見問題區塊** — 486/766 篇（63%）
