...
- **全站平均分數：58.3 / 100**
- 分項平均：A 直接回答 14.1/30　B 結構化資料 15/25　C 可擷取性 10.6/20　D 實體一致性 12.1/15　E 新鮮度 6.4/10
- 分數分布：0-40 分 **29 篇**　41-60 分 **386 篇**　61-80 分 **344 篇**　81-100 分 **7 篇**

## 各分類平均分數

| 分類 | 篇數 | 總分 | A/30 | B/25 | C/20 | D/15 | E/10 |
|---|---|---|---|---|---|---|---|
| 旅行技巧 | 185 | 60.1 | 13.7 | 18.8 | 10.3 | 11.1 | 6.1 |
| 美食景點活動 | 162 | 58.8 | 14.3 | 14.6 | 11.2 | 12.6 | 6.2 |
| 住宿推薦 | 93 | 61.8 | 15.7 | 14.2 | 11.3 | 13.5 | 7.2 |
| 新聞存檔 | 86 | 46.8 | 11.2 | 10.9 | 6.7 | 12.7 | 5.4 |
| 遊記分享 | 71 | 56.8 | 13.6 | 12.2 | 11.3 | 12.4 | 7.2 |
| 峇里島分區攻略 | 60 | 62.3 | 15.9 | 15.6 | 11.6 | 12.6 | 6.8 |
| 簽證通關 | 44 | 58 | 15.4 | 14.4 | 11.1 | 10.8 | 6.3 |
| 家庭親子 | 37 | 60 | 14.5 | 13.9 | 12.3 | 12.4 | 6.9 |
| 叫車包車 | 19 | 53.6 | 14.1 | 12.5 | 10.1 | 10.4 | 6.5 |
| 新手指南 | 7 | 76.1 | 18.3 | 21.9 | 15.4 | 13 | 7.6 |
| 無分類 | 2 | 53.7 | 20.2 | 8 | 9.5 | 9.5 | 6.5 |

## 全站系統性問題 Top 5

1. **缺列點式 TL;DR 摘要（layout callout 只有單句）** — 727/766 篇（95%）
   - 修法：逐篇補 3-5 點摘要；或在 layout 擴充 quickAnswer 支援多點式（需 frontmatter 新欄位，半自動可行）
   - 層級：逐篇（可半自動）
2. **開頭 150 字沒有直接回答** — 549/766 篇（72%）
...
4. **住宿文 Hotel schema 未輸出（hotel-cache.json 有 253 筆資料）** — 12/93 篇（13%）
   ...
   - 層級：layout/一次性
5. **更新日期超過 30 個月或含過時訊號** — 57/766 篇（7%）
...
| 6 | 簽證入境 | [申請印尼/峇里島eVoa沒辦法上傳照片? 這裡教你如何解決](/blog/bali-evoa-photo-fix/) | 45 | 開頭150字內補直接回答段：針對「申請印尼/峇里島eVoa沒辦法上傳照片? 這裡教你」先給結論（推薦名單/價格區間/具體 |
| 7 | 簽證入境 | [印尼/峇里島電子簽證申請小插曲：如何修改e-VOA資料錯誤？](/blog/bali-evisa-error-correction/) | 45.9 | 開頭150字內補直接回答段：針對「印尼/峇里島電子簽證申請小插曲：如何修改e-VOA」先給結論（推薦名單/價格區間/具體 |
...
| 23 | 機場 | [從烏布前往峇里島國際機場要多久? 如何準備，避免錯過航班](/blog/ubud-airport-transport-tips/) | 62 | 開頭150字內補直接回答段：針對「從烏布前往峇里島國際機場要多久? 如何準備，避免錯」先給結論（推薦名單/價格區間/具體 |
...
| 26 | 熱門區住宿 | [探索峇里島獨特魅力：Sanur沙努爾攻略地圖](/blog/sanur-travel-map/) | 49 | 開頭150字內補直接回答段：針對「探索峇里島獨特魅力：Sanur沙努爾攻略地圖」先給結論（推薦名單/價格區間/具體做法） |
| 27 | 熱門區住宿 | [【出發前往峇里島離島】沙努爾行李寄放攻略](/blog/sanur-luggage-storage-guide/) | 50 | 文末加「常見問題」H2區塊（3-5題問答），此分類會自動產FAQPage schema |
| 28 | 稅務 | [峇里島最新消息：3/26開始旅遊稅抽查！](/blog/bali-tourism-tax-update/) | 51 | 文末加「常見問題」區塊（3-5題）；FAQPage schema需在SEO.astro擴充此分類才會輸出 |
| 29 | 網卡 | [印尼行動通訊新政策：eSIM與SIM卡限額即將實施！](/blog/indonesia-esim-policy/) | 52.5 | 開頭150字內補直接回答段：針對「印尼行動通訊新政策：eSIM與SIM卡限額即將實施」先給結論（推薦名單/價格區間/具體 |
| 30 | 熱門區住宿 | [峇里島長谷 MAJA Canggu 住宿體驗：彷彿置身地中海的純白夢境](/blog/maja-canggu-mediterranean-stay/) | 52.6 | 開頭150字內補直接回答段：針對「峇里島長谷 MAJA Canggu 住宿體驗：彷彿」先給結論（推薦名單/價格區間/具體 |
