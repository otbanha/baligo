...
> 產生時間：2026-07-05　掃描 768 篇　跳過 9 篇
> 詳細逐篇資料見 aeo-audit-report.csv

## 總覽

- **全站平均分數：62 / 100**
- 分項平均：A 直接回答 17.6/30　B 結構化資料 15.2/25　C 可擷取性 10.6/20　D 實體一致性 12.2/15　E 新鮮度 6.4/10
- 分數分布：0-40 分 **16 篇**　41-60 分 **257 篇**　61-80 分 **478 篇**　81-100 分 **17 篇**

## 各分類平均分數

| 分類 | 篇數 | 總分 | A/30 | B/25 | C/20 | D/15 | E/10 |
|---|---|---|---|---|---|---|---|
| 旅行技巧 | 185 | 65.3 | 17.8 | 19.9 | 10.4 | 11.2 | 6.1 |
| 美食景點活動 | 162 | 63.4 | 18.7 | 14.6 | 11.2 | 12.6 | 6.2 |
| 住宿推薦 | 94 | 64.9 | 18.6 | 14.2 | 11.4 | 13.5 | 7.2 |
| 新聞存檔 | 87 | 46.8 | 11.1 | 10.9 | 6.7 | 12.7 | 5.4 |
| 遊記分享 | 71 | 59.6 | 16.4 | 12.2 | 11.4 | 12.4 | 7.2 |
| 峇里島分區攻略 | 60 | 66.4 | 19.9 | 15.6 | 11.7 | 12.6 | 6.8 |
| 簽證通關 | 44 | 62.1 | 19.3 | 14.4 | 11.2 | 10.8 | 6.3 |
...
| 21 | 機場 | [峇里島 Wanna Jungle 旅遊指南：入園門票、低消限制、交通接送與烏布一](/blog/wanna-jungle-pool-club-ubud/) | 63.3 | 文末加「常見問題」區塊（3-5題）；FAQPage schema需在SEO.astro擴充此分類才會輸出 |
| 22 | 機場 | [抵達峇里島：接機的交通選擇及第一天的實用建議](/blog/bali-airport-transfer-guide/) | 67.1 | 補明確格式的關鍵資訊：價格（Rp數字）、營業/所需時間、地址或Google Maps地點名 |
| 23 | 機場 | [【機場附近餐廳】峇里島美食：Wanaku Seafood & Chinese R](/blog/wanaku-seafood-airport-bali/) | 67.5 | 文末加「常見問題」區塊（3-5題）；FAQPage schema需在SEO.astro擴充此分類才會輸出 |
...
| 30 | 熱門區住宿 | [【兩大兩小的峇里島親子遊記】全家一起玩！峇里島親子行程｜烏布玩六天：美食、景點、](/blog/bali-family-trip-ubud-guide/) | 58.5 | 文章開頭加TL;DR重點摘要（3-5個列點的快速結論），並補frontmatter description |
