...
export const tripPlannerSpots: Spot[] = [
  ...
  { id: 'ji_seafood', name: '夕陽海鮮餐廳', region: 'jimbaran', durationHours: 2, bestTime: 'sunset', audience: ['solo', 'couple', 'family', 'friends', 'elderly', 'group'], intensity: 1, allowedTimes: ['sunset', 'evening'], blogUrl: '/blog/jimbaran-seafood-restaurants-list/' },
