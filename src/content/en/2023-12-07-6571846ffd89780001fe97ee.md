...
Book a VIP pass (for up to 3 people), which offers front-row seats with cliffside ocean views. The current price is Rp3,127,628 (shared use of a large daybed), equivalent to approximately USD$200. This includes IDR1,000,000 that can be used towards food and beverages. **Note:** Children under 12 are not allowed in this area.
