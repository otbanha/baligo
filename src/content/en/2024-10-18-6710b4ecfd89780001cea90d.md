...
description: >-
  Foreigners have multiple visa and permit options for long-term stays in Bali.
  Generally, travelers can apply for the following types of visas:
pubDate: '2024-10-18'
...
Foreigners have multiple visa and permit options for long-term stays in Bali. Generally, travelers can apply for the following types of visas:
...
Each visa serves a specific purpose. In this article, we will focus on visas more suitable for long-term stays in Indonesia, namely the **Single Entry Visa**, **Multiple Entry Visa**, and **Residence Permit** (ITAS/KITAS).
...
## Using Single or Multiple Entry Visas for Long-term Stays in Bali
...
The process of obtaining a single-entry visa is relatively straightforward and inexpensive. There are several types of single-entry visas, the most commonly used being:
...
- **Single Entry Business Visa**, requiring sponsorship by an Indonesian company, permitting foreigners to attend business meetings.

In Bali, digital nomads often use single-entry visas for remote work. However, single-entry visas do not permit foreigners to work in Indonesia. If a foreigner is employed in Indonesia (working for an Indonesian company), they need a work permit and a residence permit (ITAS/KITAS).
...
The multiple entry visa is an excellent choice for foreigners planning to reside in Bali long-term but frequently traveling abroad. The multiple entry visa remains valid even after the foreigner leaves Indonesia, whereas a single-entry visa becomes invalid upon departure.
...
4. **Retirement Residence Permit**, available to foreigners aged 55 and above. This permit is sponsored by a company recognized by the Directorate General of Immigration. The retirement residence permit does not allow foreigners to work in Indonesia but permits them to enjoy their retirement in the country.
