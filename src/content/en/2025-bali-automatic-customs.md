...
title: Quick and Convenient! Bali's Automated Immigration Process & Tips for 2025
description: >-
...
The airport staff were very friendly. Shortly after disembarking, someone asked if we had already applied for the e-visa and kindly guided us to the automated immigration area. However, since we were traveling with a child under 14, the staff informed us that minors under 14 cannot use the automated system. Fortunately, the customs officer noticed that only one child in our family couldn’t proceed and immediately escorted them to a dedicated counter nearby. The process was highly efficient, with no queue at all. Meanwhile, the adults who had already passed through the automated system waited by the counter for the child.
...
Does this convenient service pique your interest? To use this ultra-fast automated immigration clearance system, you'll need to meet the following two essential requirements:
...
2. You must be at least 6 years old. The automated clearance system is only available for passengers aged 6 and above. Passengers under 6 years old will need to be escorted by customs officers to designated counters for manual clearance.
