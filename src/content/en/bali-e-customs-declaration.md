...
title: >-
  【2025 Update】How to Fill Out Bali's Electronic Customs Declaration Form?
  Complete eCD Process Guide for Smooth Entry
description: >-
  Essential for Your Bali Trip! Learn How to Properly Fill Out the Electronic
...
The form primarily collects travelers' personal details, itinerary information, and whether they are carrying any items that need to be declared. Both foreign tourists and returning Indonesian citizens must complete this declaration.

---

## **Where to Fill Out the Electronic Customs Form?**

You can fill it out on the **official website of Indonesia's Customs and Excise Directorate** before your departure. Airlines often provide the link as well. It's recommended to complete it before your flight to avoid delays in the customs process upon arrival.
...
- Date of Arrival
- Place of Arrival (for Bali, it's DPS / Ngurah Rai)
...
- Family Arriving with You (number of accompanying family members, excluding yourself, maximum of 10. If traveling with relatives, additional passport and personal details are required)

![raw-image](https://images.gobaligo.id/vocus/vocus_f680fec20d1b6bf1f1cf3c81af7329d5.jpg)

The [+Add] button in the bottom right corner allows you to add up to 10 travel companions.

### **Page 3: Declaration of Items**

Each item category has a 'Yes / No' option. If you select 'Yes,' additional details such as quantity, value, and description are required. Common items that need to be declared include animal and plant products, alcohol, tobacco, etc. (see the item list below for details).

### **IMEI Registration**

![raw-image](https://images.gobaligo.id/vocus/vocus_c76056591f440cfde9bebd9abb547364.png)

The updated eCD includes a new question: 'Do you intend to use a mobile phone, handheld device, or tablet purchased abroad to connect to the local mobile network after arriving in Indonesia?'
...
- If you **are staying for less than 90 days** and only using roaming or a short-term local SIM card (for tourism purposes), you don't need to declare it, nor will you be required to register your IMEI.
...
- **High-value purchased items**: exceeding USD$500 requires tax payment
...
Make sure to check the downloaded or screenshot QR code and avoid accidentally deleting it.

### **Pay Bali Tourism Tax**

Starting from 2024, each foreign tourist is required to pay a one-time tourism tax of IDR 150,000 (approximately USD$10). You can pay it online before departure [here](https://lovebali.baliprov.go.id/home).

### **Fill Out Indonesia's Health Declaration SSHP**
