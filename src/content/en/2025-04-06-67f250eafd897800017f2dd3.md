...
- **Global Brand**: Originating from New Zealand, Clip 'n Climb has over 350 locations in more than 50 countries, with Bali's center being the first in Indonesia.
- **Diverse Climbing Challenges**:
  - **25 Unique Climbing Walls**, including the 9-meter-high 'Speed Climb', 'Dry Ice' (simulating a Himalayan climb), and 'Skyscraper'.
...
- **Safety and Accessibility**:
  - Utilizes the **Trublue® Auto Belay System**, allowing safe experiences without prior experience.
  - Provides full equipment (harness, climbing shoes, etc.) and includes safety instruction.
- **All Ages Welcome**:
...
- **What to Wear**: Loose athletic wear and closed-toe athletic shoes (no sandals or flip-flops allowed).
- **Capacity Limit**: There is a limit on the number of climbers, so it's recommended to book/purchase tickets in advance.
- **Reservations**: Advance booking is recommended during peak seasons or for groups.
