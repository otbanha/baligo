...
embeds: []
lang: en
_srcHash: b88dde6bf2714622a360c81774f1d571
---
...
### 🗞️ Top News: Running Event & Strategic Shift

- **Massive Running Event in Gianyar**: Yesterday (4/19), a large-scale running event called "Kemala Run 2026" was held at the Bali United Training Center in Gianyar, attracting approximately 11,000 domestic and international participants (including 5K, 10K, and half marathon races), successfully boosting local sports tourism.
...
- **Tourism Market Shift**: Officials stated that the goal for 2026 is to attract 6.62 million international tourists. In response to global trends, the marketing focus will shift from long-haul routes to the **Asia-Pacific market** (such as Australia, Southeast Asia, India, China, Japan, and South Korea) to reduce reliance on unstable transit hubs.

### 🌤️ Weather Forecast

- **Today's Overview**: **Bali** will experience cloudy weather during the day today. **Thunderstorms** are possible.

### 📄 Topics of Interest for Tourists: Volcano, Transportation & Visa

- **Volcanic Ash Alert Continues**: Recently, **Mount Lewotobi** on Flores Island has been continuously active, with ash clouds affecting flights between Australia and Indonesian islands (some airlines were still closely monitoring yesterday). Although Ngurah Rai Airport is currently operating normally, **please confirm flight status before traveling**.
...
> [「All Indonesia」Arrival Card｜Understand the Latest Process in 1 Minute: From Landing → Customs → Baggage Claim](/blog/bali-all-indonesia-arrival-guide/)
