...
embeds: []
lang: en
_srcHash: 9283273b4d3859b964f34d2daf6736d2
---
...
2. **On Departure Day (Bali Ngurah Rai International Airport DPS)**:
    ...
    - Pre-apply via the official app on your phone or computer: Visit [**https://vatrefundapp.pajak.go.id/**](https://vatrefundapp.pajak.go.id/) to log in or register → Create a new refund application → Fill in your address, departure/arrival dates → Select the invoices for refund → Choose the refund method → Take photos of the goods → Submit.
