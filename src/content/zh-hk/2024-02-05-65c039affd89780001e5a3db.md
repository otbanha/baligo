...
自2024年起，印尼將鼓勵計劃前往峇里島嘅遊客使用線上移民服務。遊客可以線上申請各種印尼簽證，亦可以線上辦理簽證延期手續，唔使再跑到移民局辦公室親自辦理啦！（2025/05/29最新更新：而家又改成要去移民局辦公室按手指模囉！請睇[呢度](/blog/2025-06-03-683e4b26fd89780001ea2016/)）
...
如果你已經自行取得咗電子落地簽證（eVOA）並決定喺印尼延長逗留時間（30日以上），你就需要延長你嘅簽證。為此，你需要準備好你嘅手機/電腦同埋一張信用卡，為咗加快流程，我哋特別為你準備咗詳細嘅操作指引。
...
喺主頁上，搵到選單中嘅"extend"選項並點擊進入。喺列表中找到你嘅有效eVOA。如果呢次係你第一次延長簽證，咁列表中應該只有一個項目。選擇佢。你唔需要填寫任何表格；所有數據都會自動從你嘅個人帳戶轉移過嚟。
...
跟住，你需要輸入信用卡嘅詳細資料，如下面張截圖所示。輸入完之後，撳下面個紅色掣"而家支付"（BAYAR SAKARANG）。
...
喺右邊嘅"狀態"部分，你會見到一條綠色底嘅信息"已支付"，表示支付成功。喺呢條信息下面，有個標住"e-ITK"嘅掣；撳佢就可以睇到你嘅簽證。
...
我哋建議你截圖或者列印呢份文件，因為...當你離開印尼/峇里島嗰陣，你本護照上面唔會有任何註記話你已經延長咗簽證，所以截圖或者印出嚟方便出示畀相關人員會比較穩陣。
