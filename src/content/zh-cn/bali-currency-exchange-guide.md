...
是的，建议保留换汇收据，以便在出现问题时有所凭据。同时，记录每次换汇的金额和汇率，方便后续的财务管理。
...
建议用有提供海外消费回馈、低或没有海外手续费的信用卡，在大型饭店或大餐厅消费使用，这样可能更划算。这样既能享受到美金换汇的好汇率，又保留了弹性！小提醒：有团友曾在**小超市使用信用卡就被盗刷**，信用卡请谨慎使用！
