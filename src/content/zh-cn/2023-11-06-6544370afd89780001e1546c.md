...
**尿布**：品牌选择跟台湾不太一样。比较好用的选择是韩国和日本品牌，像是 Genki、Makuku、Merries，有些地方也有可生物分解的 Ecoboom。需要注意的是，Merries 在岛上销售的大多是印尼当地生产版本，品质有落差，真正日本制的白色包装只有少数通路（如 Clandy's 或 Bali Hypermart）才有，也可以在 Shopee/Tokopedia 在线订购。泳裤型尿布几乎只有在线买得到，建议从台湾带足。
