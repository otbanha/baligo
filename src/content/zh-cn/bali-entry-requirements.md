...
description: >-
  想去巴厘岛度假，或即将踏上印尼的旅游旅程？别忘了除了订好机票和住宿，还有几份重要的入境文件需要提前准备。这些文件若未事先完成，不仅可能耽误登机，也可能在入境时面临困难。为了让你顺利通关，以下整理出目前最新的四大入境文件，包含申办时间、有效期限与注意事项，一次看懂、轻松准备！
pubDate: '2025-07-05'
...
---
**先讲结论**：入境印尼巴厘岛需备齐 **4 份文件**，各自申办时间不同——① **电子签证 eVoA**（出发前申请，核发后 90 天内须完成入出境）② **电子报关 eCD**（只能在出发前 3 天内填写）③ **健康声明 SSHP**（入境前 3 天内填写）④ 观光税缴纳证明。时间点记混最容易出包，尤其 eCD 提早填会系统挡掉、太晚填又怕临场手忙脚乱，建议统一在出发前 2-3 天一次办完。
...
**快速参考：**印尼/巴厘岛入境新规：搭机前必填健康声明表SSHP/填写教学
...
A：建议提前办理线上签证。可在机场办理落地签，但手续较慢、排队时间长，且不保证顺利核发。

**Q2：eCD 报关表需要打印吗？**

A：不需要打印，填写完成后会获得 QR Code，出示手机扫描即可。
...
A：是的。观光税为每次入境皆需缴纳的费用，不具备多次使用效力。
