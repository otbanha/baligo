...
有了这些提前准备，巴厘岛的入境流程会变得更顺畅，省去当场填表排队的时间。如果还不太清楚流程的，可以参考这里详细的说明。现在第一关和第三关已合并：「[【2026版】印尼巴厘岛入境使用「All Indonesia」入境卡｜1分钟搞懂最新流程：下飞机→过海关→领行李全攻略](/blog/bali-all-indonesia-arrival-guide/)」
...
7. **语言选择**
   我们的包车司机主要提供英文服务，若对英文沟通较有自信的话，其实无需另请中文导游。我自己在出发的首尾两天都是轻松的行程，因此由包车司机带领即可；中间几天因为行程较远，就请了中文导游Ani全程陪伴。在行前的沟通中，也可以灵活使用ChatGPT或Google翻译进行协助，确保双方都清楚彼此需求。
...
> 编按：以上乌布景点都收录在「[巴厘岛乌布完整攻略：100种深入认识乌布的方式](/blog/ubud-guide/)」
