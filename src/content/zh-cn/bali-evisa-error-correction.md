...
**先说结论（2024年7月更新）**：e-VOA资料填错**已经无法要求修改**——印尼移民局自2024年7月起不再受理更正申请。正确做法是：**付款前务必逐字检查**姓名、出生地、护照号码，发现错误就不要付款、直接重新申请；若付款后才发现错误，只能重办一份新的e-VOA。本文前半段的写信修改方法是旧制，已失效，留作参考。
...
请印尼移民局协助修改是唯一的解决方法。建议您在上班时间通过[印尼移民局网站](https://evisa.imigrasi.go.id/)的Contact Us（在首页的右上角）获取协助。

电子邮件往返最好能一针见血，让人家知道你的问题在哪里。请依照下列格式在email中附上信息，就能以最快的速度完成电子签证上姓名、出生地等等常见的错误：
