---
title: 印尼/巴厘岛到处都在用电子支付！怎么付款？QRIS、GoPay电子钱包支付攻略｜信用卡也能用
slug: indonesia-bali-electronic-payment-qris-gopay-guide
description: 去巴厘岛旅游怎么付款？完整介绍 QRIS、GoPay 电子支付，教你用信用卡扫码付款、现金充值与便利店提现，轻松搞懂巴厘岛 Cashless 支付方式。
...
去巴厘岛旅游，还在每天身上放一大叠印尼盾吗？

现在在印尼、尤其是巴厘岛，越来越多餐厅、咖啡厅、SPA、景区门票、商店，甚至路边商贩都开始使用电子支付。有些店家甚至会直接告诉你：

**「Cashless Only」**

意思就是：**只接受无现金电子支付，不收现金！**
...
再搭配像 **GoPay** 这类电子钱包，现在在巴厘岛旅游，已经可以大幅减少携带大量现金的需求。

这篇就一次整理给你：
**QRIS 是什么？外国游客怎么使用？GoPay 怎么注册？台湾、香港、新加坡、马来西亚旅客又分别可以怎么付款？**

![raw-image](https://images.gobaligo.id/images/2026-09/1789714091020-qris4.png)

***

## 🇮🇩 QRIS 是什么？为什么巴厘岛到处都是 QR Code？

QRIS 全名是 **Quick Response Code Indonesian Standard**，可以简单理解成「印尼统一 QR Code 支付标准」。

在印尼，餐厅、咖啡厅、便利店、SPA、小型商家、旅游景点甚至街边摊，都可能看到 QRIS 的 QR Code。

只要你的支付 App 支持 QRIS，就可以直接扫描店家的 QR Code，输入金额后完成付款。

Bank Indonesia 表示，QRIS 已经广泛使用于印尼各省、市，包括微型商家、旅游目的地等。
...
这就是很多第一次去巴厘岛的人最容易搞混的地方。

因为：

**「QRIS 可以用」≠「任何国家的信用卡都能直接扫 QRIS」。**

目前印尼已经推出 **QRIS Cross-Border（跨境 QRIS）**，让部分合作国家的旅客可以直接使用自己国家的支付 App，在印尼扫 QRIS 付款。

目前 Bank Indonesia 已与包括：
...
不过，这并不代表台湾、香港旅客完全不能使用 QRIS。

目前比较实际的方式，就是：

## 📱 GoPay＋Visa／Mastercard

GoPay 现在已经支持在 GoPay App 中绑定 Visa 或 Mastercard 信用卡／借记卡，并使用该卡作为支付来源来支付 QRIS。

换句话说：

**台湾、香港旅客 → GoPay → 绑 Visa／Mastercard → 扫 QRIS**

是一个可以研究的方案。

不过这里有一个非常重要的限制：

## ⚠️ GoPay 信用卡/借记卡支付QRIS并不是无上限
...
那么 GoPay 可以列入巴厘岛旅游的支付工具之一。

而且 GoPay 的用途不只是扫 QRIS。

[iOS下载](https://apps.apple.com/id/app/gopay-transfer-payment-qris/id6446321594) | [Android下载](https://play.google.com/store/apps/details?id=com.gojek.gopay&hl=id)
...
使用已绑定在 GoPay App 的 **Visa 信用卡／借记卡**支付 QRIS，可享每张卡每月最多 **10 笔免 Admin Fee**。

而且是「每张已绑定的 Visa 卡」计算。

所以如果你刚好在 2026 年 9 月前往巴厘岛，可以留意这项活动。

不过活动属于限时优惠，**出发前最好再直接确认 GoPay App 里显示的最新活动条件。**
...
的人来说，也可以减少把大量现金放在酒店、背包或储物柜里的需求。
...
另外，GoPay Plus 的每月累计余额流入上限为 Rp40,000,000。

所以如果旅途中会长时间使用 GoPay，或需要比较高的余额，就要注意自己的账户验证状态与额度。

***

## 🌏 不同国家的旅客，巴厘岛付款方式整理

| 旅客 | QRIS Cross-Border | 建议付款方式 |
| --- | --- | --- |
| 🇸🇬 新加坡 | ✅ 支持 | 参与的银行／支付 App 直接扫 QRIS |
| 🇲🇾 马来西亚 | ✅ 支持 | 支持 DuitNow QR 的银行／电子钱包 |
| 🇹🇭 泰国 | ✅ 支持 | 支持 PromptPay 的支付 App |
| 🇯🇵 日本 | ✅ 支持 | 支持 QRIS Cross-Border 的支付 App |
...
尤其现在 QRIS 已经成为印尼非常普及的电子支付标准，加上 QRIS Cross-Border 持续扩大，新加坡、马来西亚等旅客甚至可以直接利用当地支持的支付 App 扫码付款。

对台湾、香港旅客来说，则可以考虑 **GoPay＋Visa／Mastercard** 这类方式，但要特别留意目前的交易限制与手续费规则。

所以最实用的巴厘岛付款策略，其实不是「完全不帶现金」，而是：

**💳 信用卡＋📱 电子支付＋💵 少量现金**

三种方式搭配。

这样遇到「Cashless Only」不用慌，遇到只收现金的店家也不会尴尬。

***

## 📌 小提醒

GoPay 的账户额度、QRIS 卡片支付规则、手续费、便利店服务及优惠活动都可能调整。

**出发前请以 GoPay App、GoPay 官方公告及发卡银行最新规定为准。**

尤其是 Visa × GoPay 的「每张卡每月 10 笔免 Admin Fee」活动，目前只到 **2026 年 9 月 30 日**。

更多巴厘岛旅游攻略、住宿、交通、景点与最新旅游资讯，欢迎持续关注 **巴厘岛旅游攻略 gobaligo.id**。
